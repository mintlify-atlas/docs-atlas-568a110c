...
description: "Upload and embed PDF, DOCX, PPTX, XLSX, and TXT files. NISIRA chunks documents per format, generates 768-dimensional embeddings, and stores them in pgvector or ChromaDB."
---
...
| `file_type` | `CharField` | MIME type (e.g. `application/pdf`) |
...
| `embeddings_generated` | `BooleanField` | Whether embeddings have been stored |

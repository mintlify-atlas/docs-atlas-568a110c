...
description: "NISIRA dynamically computes top-k (3–15) for each query based on length, question count, and complexity keywords — ensuring efficient retrieval without sacrificing coverage."
---
...
# → 9 (base ≥150 chars) + 4 (3×?) + 3 (3 keywords) = 16 → capped to 15
```

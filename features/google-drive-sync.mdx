---
title: "Sync Documents from Google Drive into NISIRA"
sidebarTitle: "Drive Sync"
description: "Automatically ingest files from a Google Drive folder into the RAG pipeline. Configure a service account or OAuth token, set a folder ID, and enable polling-based sync."
---

...
<Note>
  The Django built-in admin interface is available separately at `/django-admin/`. Use it for low-level model inspection, bulk operations, and direct database access outside the scope of the React panel.
</Note>

---
title: "RAG Pipeline Configuration Reference"
sidebarTitle: "RAG Settings"
description: "Tune retrieval behavior, chunking strategy, embedding model, and vector store backend. All settings live in rag_system/config.py and are controllable via environment variables."
---

---
title: "NISIRA Assistant LLM Providers Configuration Guide"
sidebarTitle: "LLM Providers"
description: "Configure Gemini, OpenRouter, or Groq as the RAG generation backend. Switch providers with one env variable and tune model, temperature, and token limits."
---
